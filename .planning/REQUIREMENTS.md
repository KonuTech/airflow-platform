...
- [x] **CICD-09**: An ephemeral kind cluster in CI deploys the stack and runs E2E, proving the environment can be recreated from the repository — *(DoD 113)*
